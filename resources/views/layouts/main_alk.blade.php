...
<html class="no-js" lang="hu">
  ...
  <script>
    function getData(btn) {
        ...
        xmlhttp.open("GET", "/alkategoriaOldal/modals/modals/{{$foKategoria}}/"+btn.id, true);
        xmlhttp.send();
      }
    ...
    function getTable(btn) {
      var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
        document.getElementById("dokTable").innerHTML = this.responseText;
      };
      xmlhttp.open("GET", "/alkategoriaOldal/modals/dokumentumokTable/{{$foKategoria}}/"+btn.id, true);
      xmlhttp.send();
    }

    function deleteFile(btn, alkategoria) {
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
        document.getElementById("deleteFile").innerHTML = this.responseText;
      };
