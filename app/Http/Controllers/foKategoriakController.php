...
class foKategoriakController extends Controller
{
	...
	public function ujFoKategoriaHozzadasa(Request $request){
        ...
        //Validálás
        if(!isset($nev)){
            return \Redirect::to("fooldal/index")->with('error', 'Sikertelen művelet! Nincs megadva kategória név!');;
        }
        ...
        //Fő kategória hozzáadása az adatbázishoz
        ...
        return \Redirect::to("fooldal/index")->with('uzenet', 'Új fő kategória sikeresen hozzá adva!');;
    }
    ...
    public function foKnevValtozatas(Request $request){
        ...
        //Validálás
        if(!isset($ujNev)){
            return \Redirect::to("fooldal/index")->with('error', 'Sikertelen művelet! Nincs megadva új fő kategória név!');;
        }
        ...
        //Fő kategória nevének megváltoztatása az adatbázisban
        ...
        //Fő kategóriához tartozó mappa nevének megváltoztatása
        ...
        return \Redirect::to("fooldal/index")->with('uzenet', 'Fő kategória neve megváltozott!');;
    }
    ...
    public function foKtorles(Request $request){
        ...
        return \Redirect::to("fooldal/index")->with('uzenet', 'Fő kategória sikeresen törölve!');;
    }
